...
public class SseApiController {
    ...
    // receive every request in new thread. Save generated emitter in userConnection.
    // then all threads: saving emitter thread, taking out emitter thread, and pushing thread will be different.
    // race between threads might happen. ConcurrentHashMap is thread race-safe data structure
